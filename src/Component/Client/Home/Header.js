        ...
        <header className="header">
            <div>
                <nav class="header__navbar hide-on-mobile-tablet">
                    <ul>
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            ...
                            <div class="header__qr">
                                <img src="./assets/img/QR.png" alt="QR code" class="header__qr-img"></img>
                                <div class="header__qr-apps">
                                    <a href="#" class="header__qr-link">
                                        <img src="./assets/img/GooglePlay.png" alt="Google play"
                                            class="header__qr-download-img"></img>
                                    </a>
                                    <a href="#" class="header__qr-link">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item header__navbar-user">
                            <img src="http://localhost:3000/f8-shop/assets/img/user.png" alt="User" class="header__navbar-user-img"></img>
                ...
                <div class="header-with-search">
                    ...
                    <input type="checkbox" hidden id="mobile-search-checkbox" class="header__search-checkbox"></input>

                    <div class="header__search">
                        <div class="header__search-input-wrap">
                            <input type="text" class="header__search-input" placeholder="Nhập để tìm kiếm sản phẩm"></input>
                        ...
                        <div class="header__cart">
                            <div class="header__cart-wrap">
                                ...
                                <div class="header__cart-list">
                                    <img src="./assets/img/no-cart.png" alt="No cart" class="header__cart--no-cart-img"></img>
