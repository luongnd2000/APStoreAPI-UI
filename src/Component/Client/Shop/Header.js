...
class Header extends Component {
    ...
    SetLogout = (e) => {
        ...
        const cookies = new Cookies();
        cookies.set('UserLogin', null, { path: '/' })
                    ...
                    <nav className="header__navbar hide-on-mobile-tablet">
                        <ul>
                            ...
                            <div className="header__qr">
                                    <img src="http://localhost:3000/f8-shop/assets/img/QR.png" alt="QR code" className="header__qr-img"></img>
                                    <div className="header__qr-apps">
                                        <a href="/#" className="header__qr-link">
                                            <img src="./assets/img/GooglePlay.png" alt="Google play"
                                                className="header__qr-download-img"></img>
                                        </a>
                                        <a href="/#" className="header__qr-link">
                        ...
                        <ul className="header__navbar-list">
                            <li className="header__navbar-item header__navbar-item--strong header__navbar-item--has-notify">
                                ...
                                <div className="header__notify">
                                    ...
                                    <ul className="header__notify-list">
                                        <NotifyItem
                                            Title="Thông báo 1"
                                            Content="Thông báo...."
                                            ImagePath="https://img.abaha.vn/photos/resized/200x120/121-1608210033-demoweb.png"
                                        ></NotifyItem>
                                    </ul>
                            ...
                            {!this.state.IsLogin ? <LoginLogout></LoginLogout> : null}
                            {this.state.IsLogin ? <UserAccount NameDisplay={this.state.UserLogin.NameDisplay} SetLogout={this.SetLogout} /> : null}
                        </ul>
                    </nav>

                    <div className="header-with-search">
                        <label className="header__mobile-search">
                            <i className="fas fa-search header__mobile-search-icon"></i>
                        </label>

                        <div className="header__logo hide-on-tablet">
                            <a href="/Shop" className="header__logo-link">
                        ...
                        <div className="header__search">
                            ...
                            <div className="header__search-select">
                                ...
                                <i className="fas fa-angle-down header__search-select-icon"></i>
                        ...
                        <div className="wrap-cart-login">
                            <Cart></Cart>
                            <div className="login-on-mobile-tablet header__navbar-item header__navbar-user hide-on-pc">
...
function LoginLogout() {
    return (
        <div>
            ...
            <li className="header__navbar-item header__navbar-item--strong header__navbar-item--separate"><a href="/#" className="header__navbar-item-link">Đăng ký</a></li>
            <li className="header__navbar-item header__navbar-item--strong"><Link to="/Login" className="header__navbar-item-link">Đăng nhập</Link></li>
        </div>
